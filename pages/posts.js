    ...
    <Layout>
      <Container>
        <Section delay={0.1}>
          ...
          <Paragraph>
            I will be sharing content to help fellow developers learn, grow and give something back to the community what I have learnt.
          </Paragraph>
        </Section>
        <SimpleGrid columns={[1, 1, 2]} gap={6}>
          <Section>
            ...
            >
              Create an Effective Software Engineer Résumé and land jobs at FAANG!
            </UsesGridItem>
          </Section>
        </SimpleGrid>
      </Container>
